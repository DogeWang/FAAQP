...
from schemas.flights.schema import gen_flights_origin_schema, gen_flights_sample001_schema, gen_flights_10_schema\
    , gen_flights_20_schema, gen_flights_40_schema, gen_flights_80_schema, gen_flights_5m_order_schema, gen_flights_10m_order_schema, gen_flights_20m_order_schema
...
from schemas.dom1000.schema import gen_dom1000_schema, gen_c00s10_schema, gen_c02s10_schema, gen_c04s10_schema, \
    ...
    gen_c10s10_schema
from schemas.airbnb.schema import gen_airbnb_schema
...
if __name__ == '__main__':
    ...
    if args.dataset == 'imdb-light':
    ...
    elif args.dataset == 'ssb-1':
        schema = gen_sf50_ssb_schema(table_csv_path)
    elif args.dataset == 'flights1B':
        schema = gen_flights_1B_schema(table_csv_path)
    elif args.dataset == 'flights_origin':
        schema = gen_flights_origin_schema(table_csv_path)
    elif args.dataset == 'flights_5m_order':
        schema = gen_flights_5m_order_schema(table_csv_path)
    elif args.dataset == 'flights_10m_order':
        schema = gen_flights_10m_order_schema(table_csv_path)
    elif args.dataset == 'flights_20m_order':
        schema = gen_flights_20m_order_schema(table_csv_path)
    elif args.dataset == 'flights_10m':
        schema = gen_flights_10_schema(table_csv_path)
    elif args.dataset == 'flights_20m':
        schema = gen_flights_20_schema(table_csv_path)
    elif args.dataset == 'flights_40m':
        schema = gen_flights_40_schema(table_csv_path)
    elif args.dataset == 'flights_80m':
        schema = gen_flights_80_schema(table_csv_path)
    elif args.dataset == 'flights_sample001':
        ...
        schema = gen_c02s10_schema(table_csv_path)
    elif args.dataset == 'c04s10':
        schema = gen_c04s10_schema(table_csv_path)
    elif args.dataset == 'c04s00':
        schema = gen_c04s00_schema(table_csv_path)
    elif args.dataset == 'c04s05':
        schema = gen_c04s05_schema(table_csv_path)
    elif args.dataset == 'c04s15':
        schema = gen_c04s15_schema(table_csv_path)
    elif args.dataset == 'c04s20':
        schema = gen_c04s20_schema(table_csv_path)
    elif args.dataset == 'c06s10':
        schema = gen_c06s10_schema(table_csv_path)
    elif args.dataset == 'c08s10':
        schema = gen_c08s10_schema(table_csv_path)
    elif args.dataset == 'c10s10':
        schema = gen_c10s10_schema(table_csv_path)
    elif args.dataset == 'airbnb':
        schema = gen_airbnb_schema(table_csv_path)
    else:
    ...
    if args.evaluate_aqp_queries:
        ...
        # utils.toolkit.get_leaf(args.ensemble_location)
        # print(args.ensemble_location, args.query_file_location, args.target_path, schema,
        #                      args.ground_truth_file_location, args.rdc_spn_selection, args.pairwise_rdc_path,
        #                      args.max_variants, args.merge_indicator_exp, args.exploit_overlapping, 0, True,
        ...
        # utils.error_statistic.error_percentile(args.target_path)

...
SELECT AVG(distance) FROM flights WHERE air_time > 100;
SELECT AVG(dep_delay) FROM flights WHERE unique_carrier = '9E';
SELECT AVG(distance) FROM flights WHERE air_time > 100 AND dest = 'JFK';
SELECT AVG(distance) FROM flights WHERE dep_delay > 1000 AND air_time < 2000;
